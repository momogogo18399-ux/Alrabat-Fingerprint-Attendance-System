...
# -*- coding: utf-8 -*-
"""
Login Window - Fixed Layout Design
Beautiful and modern login interface with proper spacing
"""
...
class LoginWindow(QMainWindow):
    ...
    def __init__(self, db_manager=None):
        ...
        self.setFixedSize(500, 700)  # Increased height for better spacing
    ...
    def setup_ui(self):
        """Setup the modern and beautiful UI with proper spacing"""
        ...
        main_layout.setSpacing(20)  # Reduced spacing between elements
    ...
    def setup_logo_section(self, layout):
        ...
        logo_container.setFixedSize(100, 100)  # Reduced size
    ...
    def setup_title_section(self, layout):
        ...
        main_title.setFont(QFont("Segoe UI", 20, QFont.Weight.Bold))  # Reduced font size
        ...
        subtitle.setFont(QFont("Segoe UI", 12, QFont.Weight.Normal))  # Reduced font size
    ...
    def setup_progress_section(self, layout):
        ...
        self.progress_bar.setFixedHeight(25)  # Fixed height
    ...
    def setup_login_form(self, layout):
        ...
        self.username_input.setFixedHeight(40)  # Reduced height
        ...
        self.password_input.setFixedHeight(40)  # Reduced height
        ...
        self.login_button.setFixedHeight(45)  # Reduced height
